...
namespace EditorPanelElements {
    public class TitleInputField : EditorPanelElement {
        ...
        public TitleInputField(string placeholder, string defaultValue, UnityEngine.UI.InputField.ContentType contentType,
            System.Action<string> action, GameObject parent, Vector2 pos, float widthFactor = 1.0f, string tooltip = null, string tag = null)
        : base("", parent, pos, widthFactor, tooltip, tag) {
            this.action = action;
